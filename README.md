...
5. Static inner classes must be instanciated with `new (jsava.Utils.getStaticClass( this, 'SomeClass' ))(...)`, otherwise
it will result in wrong behavior when the class is inherited.
